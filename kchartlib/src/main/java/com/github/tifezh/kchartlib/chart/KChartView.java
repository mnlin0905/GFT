 ...
 */
public abstract class KChartView extends BaseKChartView implements CommonChartUpDownModeColor {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if(array!=null)
        {
            try {
                ...
                setTextColor(getSkinColorResource(array,R.styleable.KChartView_kc_text_color,R.color.chart_text));
                setLineWidth(array.getDimension(R.styleable.KChartView_kc_line_width,getDimension(R.dimen.chart_line_width)));
                setBackgroundColor(getSkinColorResource(array,R.styleable.KChartView_kc_background_color,R.color.chart_background));
                setSelectedLineColor(getSkinColorResource(array,R.styleable.KChartView_kc_selected_line_color,R.color.chart_text));
                ...
                setGridLineColor(getSkinColorResource(array,R.styleable.KChartView_kc_grid_line_color,R.color.chart_grid_line));
                //macd
                ...
                setSelectorBackgroundColor(getSkinColorResource(array,R.styleable.KChartView_kc_selector_background_color,R.color.chart_selector));
                ...
                //tab
                mKChartTabView.setIndicatorColor(getSkinColorResource(array,R.styleable.KChartView_kc_tab_indicator_color,R.color.chart_tab_indicator));
                mKChartTabView.setBackgroundColor(getSkinColorResource(array,R.styleable.KChartView_kc_tab_background_color,R.color.chart_tab_background));
                ColorStateList colorStateList =getSkinColorStateListResource(array, R.styleable.KChartView_kc_tab_text_color, R.color.tab_text_color_selector) ;
     ...
     */
    @ColorInt
    protected abstract int getSkinColorResource(TypedArray array, @StyleableRes int index, @ColorRes int defaultRes);

    /**
     * 获取skin 颜色值 list
     */
    protected abstract ColorStateList getSkinColorStateListResource(TypedArray array, @StyleableRes int index, @ColorRes int defaultRes);
     ...
     * 主要 draw obj
     */
    class MyMainDraw extends  MainDraw{
        public MyMainDraw(BaseKChartView view) {
            super(view);
        }

        @Override
        public int getUpModeColor() {
            return KChartView.this.getUpModeColor();
        }

        @Override
        public int getDownModeColor() {
            return KChartView.this.getDownModeColor();
        }
    }
}
