...
public class MySkinMaterialTabLayout extends CustomTabLayout implements SkinCompatSupportable {
    ...
    public MySkinMaterialTabLayout(Context context) {
        this(context, null);
    }

    public MySkinMaterialTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySkinMaterialTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
