...
package com.linktech.gft.view.tablayout;
...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    /**
     * Add a tab to this layout. The tab will be added at the end of the stockInfo.
    ...
    class TabView extends LinearLayout {
        ...
        final private int mDefaultMaxLines = 1;
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                canvas.drawRect(mIndicatorLeft +(mIndicatorRight - mIndicatorLeft)/4, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight-(mIndicatorRight - mIndicatorLeft)/4 , getHeight(), mSelectedIndicatorPaint);
            }
        }
    }
