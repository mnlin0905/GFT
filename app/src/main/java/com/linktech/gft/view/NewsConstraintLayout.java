...
public class NewsConstraintLayout extends ConstraintLayout {
    ...
    public NewsConstraintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, R.layout.item_news_constraint, this);
        ButterKnife.bind(this, this);

        int dimension_horizontal = getResources().getDimensionPixelSize(R.dimen.view_padding_margin_16dp);
        int dimension_vertical = getResources().getDimensionPixelSize(R.dimen.view_padding_margin_12dp);
        setPadding(dimension_horizontal, dimension_vertical, dimension_horizontal, dimension_vertical);
