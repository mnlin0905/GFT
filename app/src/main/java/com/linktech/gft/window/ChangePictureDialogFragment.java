...
public class ChangePictureDialogFragment extends DialogFragment {
     ...
     * 拍照/相册选择
     */
    private String takePhotoText, fromAlbumText;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (takePhotoText != null) {
            mTvTakePhoto.setText(takePhotoText);
        }
        if (fromAlbumText != null) {
            mTvFromAlbum.setText(fromAlbumText);
        }
    ...
    public void onAttach(Context context) {
        ...
        if (getActivity() instanceof OnChangeHeadListener && listener == null) {
     ...
     * 从相机选择
     */
    public ChangePictureDialogFragment setTakePhotoText(String text) {
        this.takePhotoText = text;
        return this;
    }
     ...
     * 使用相册
     */
    public ChangePictureDialogFragment setFromAlbumText(String text) {
        this.fromAlbumText = text;
        return this;
    }
    ...
    public interface OnChangeHeadListener {
        ...
        default boolean onClickRestoreDefault(Dialog dialog) {
            return false;
        }

        default boolean onClickCancel(Dialog dialog) {
            return false;
        }
    }
}
